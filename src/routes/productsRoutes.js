...
router.post('/', authMiddleware, teacherMiddleware, upload.single('image'), productsController.store);

router.get('/cart', productsController.cart);
router.get('/search/results', productsController.search);

router.get('/:id/edit', authMiddleware, productsController.edit);
router.put('/:id', authMiddleware, upload.single('image'), productsController.update);
